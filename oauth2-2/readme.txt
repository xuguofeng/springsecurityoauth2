...
curl --user net5ijy:12345678 -X POST -d "grant_type=authorization_code&scope=all&redirect_uri=http%3a%2f%2flocalhost%3a8080&code=eIP7N6" http://192.168.186.1:7001/oauth/token

## 授权码模式 - 使用curl命令刷新token
curl --user net5ijy:12345678 -X POST -d "grant_type=refresh_token&refresh_token=ec45457e-c613-45c6-a756-be1703339d26" http://192.168.186.1:7001/oauth/token
...
## 使用浏览器或Postman请求资源
http://localhost:7001/order/demo?access_token=a1445b44-32f0-44de-b0d0-f3430e16d5d9